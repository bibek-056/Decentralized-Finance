...
contract Defi {
    ...
    constructor() {
        ...
        owner = msg.sender;
        totalStakedAmount = 0;
        totalCollectedInterest = 10;
        totalLiquidatedETH = 0;
    }
    ...
    function returnInterestRate() public view returns (uint256) {
        return interestRate;
    }
    ...
    function liquidate() public {
        for (uint256 i = 0; i < borrowerIDArray.length; i++) {
            if (
                ...
                totalLiquidatedETH += borrowerData[borrowerIDArray[i]]
                    .collateralAmount;
            }
        }
    }
    ...
    // Function to swap liquidated asset
    address private constant UNISWAP_V2_ROUTER =
        0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

    function swapLiquidatedAsset() public {
        address[] memory path;
        path = new address[](2);
    ...
    function setPriceOfETH(uint256 price) public {
        rateOfEth = price;
    }

    function increaseInterestToTestLiquidation() public {
        borrowerData[borrowerIDArray[0]].interestToPay =
            borrowerData[borrowerIDArray[0]].interestToPay *
            1000;
    }
}